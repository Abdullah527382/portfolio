...
const SIMPLEKYC_EXPERIENCE = {
    title: "Software Engineer",
        ...
        technologies: [
            "TypeScript","Docker","Kubernetes","Postgres","Microsoft SQL Server","Microsoft Azure","Google Cloud Platform (GCP)","Vue.js","Jenkins","Terraform","React.js","MySQL","Node.js"
        ], 
        responsibilities: [
            {
...
const TILITER_EXPERIENCE = {
        ...
        technologies: [
            "AWS", "TypeScript","Docker","Python","Postgres","TeamCity","Microsoft Azure","Google Cloud Platform (GCP)","Next.js","Django","Salesforce","React.js","SCCM","Node.js"
        ], 
        responsibilities: [
            {
